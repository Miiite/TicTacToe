...
abstract class $PlayerCopyWith<$Res> {
  ...
  @useResult
  $Res call({PlayerType type, int score});
}
...
class _$PlayerCopyWithImpl<$Res, $Val extends Player>
  ...
  @override
  $Res call({Object? type = null, Object? score = null}) {
    return _then(
      _value.copyWith(
            type: null == type
                ? _value.type
...
class _$PlayerImpl extends _Player {
  const _$PlayerImpl({required this.type, this.score = 0}) : super._();
...
abstract class _Player extends Player {
  const factory _Player({required final PlayerType type, final int score}) =
      _$PlayerImpl;
