  ...
  Widget build(BuildContext context) {
    return BlocListener<GameCubit, GameState>(
      ...
      listener: (context, state) {
        // Navigate to result screen when game is over
                      ...
                      return Row(
                        ...
                        children: [
                          _buildScoreCard(
                            ...
                            isActive: state.currentPlayer == PlayerType.x &&
                                !state.isGameOver,
                          ),
                          _buildScoreCard(
                            'O',
                            ...
                            isActive: state.currentPlayer == PlayerType.o &&
                                !state.isGameOver,
                          ),
                        ],
                      );
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GameCell(
                                ...
                                isWinningCell:
                                    state.winningCells.contains(index),
